...
def create_config() -> Path:
    ...
    config = {
        ...
        "mergeStrategy": {
            ...
            "ADR": {"dedupBy": "none", "action": "appendAll"}
        }
    }
...
def print_agents_guide() -> None:
    ...
    print("📋 AGENTS 规则")
    print("=" * 50)
    print("其他项目可参考 starter/AGENTS.md 模板添加自然语言指令")
    print("或运行 python scripts/pull.py 从母库同步经验")
    print("=" * 50)
...
def print_summary() -> None:
    ...
    print("📄 同步文件：ADR.md, lessons-learned.md, troubleshooting.md")
