...
description: Anthropic 出品的前端视觉设计指南：配色/字体/布局/动效，打造有辨识度的 UI
---
# Frontend Design
...
When invoked, the arguments should contain:
- The specific page/component to redesign (e.g. "HomePage", "ReportPage", "全页面")
- Any existing design assets or constraints
- The user's preferences if stated
